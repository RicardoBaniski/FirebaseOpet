...
public class CadOneActivity extends AppCompatActivity {
    ...
    public void salvarnofirebase(View view) {
        ...
        db.collection("usuarios").document(user.getUid())
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        String message = "Dados cadsatrados com sucesso!";
                        Toast.makeText(CadOneActivity.this,"",Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        String message = "Erro ao cadastrar dados!";
                        Toast.makeText(CadOneActivity.this, "", Toast.LENGTH_SHORT).show();
                    }
                });
    }
